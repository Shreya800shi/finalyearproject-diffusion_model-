...
def generate_image(input_image, prompt, progress_callback=None):
    """
    ...
    return pipeline.generate(
        prompt=prompt,
        uncond_prompt="",  # Default empty uncond_prompt (adjust if needed)
        input_image=input_image,  # Pass the PIL Image
        strength=strength,
        do_cfg=do_cfg,
        cfg_scale=cfg_scale,
        sampler_name=sampler,
